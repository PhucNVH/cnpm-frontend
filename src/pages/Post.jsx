                ...
                <Row>
                    <Col span={12} offset={4}>
                        <Form {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages}>
                            ...
                            <Form.Item name={['user', 'name']} label="Tiêu đề" rules={[{ required: true }]}>
                                <Input />
                            </Form.Item>
                            <Form.Item name={['user', 'price']} label="Giá bán" rules={[{ type: 'number', min: 0, max: 100000000 }]}>
                                <InputNumber />

                            </Form.Item>
                            <Form.Item name={['user', 'type']} label="Loại bài viết" rules={[{ required: true, message: 'Missing area' }]}>
